...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% grating parameter
wintype = 0 ; %%% 0 circle; 1 square
wincenter1=[-2.5 -4];    % [x0, y0] of the grating window, middle of the screen is [0 0]
winsize1= [4 4];	 % window size in x and y in deg. For 20 inch screen at 570mm, [40, 30] is about full screen
wincenter2=[10.5 -6];    
winsize2 =winsize1;    % [0 0] to disable 2nd grating
gratingtype1=[1];  % 1: square wave, 2: sinewave, 3: load&display image
orientation1=[0  0 45 45 90 90 135 135]';   % 0-180, use 999 for random, orientation 0 is H gratings move up, 90 is Vertical gratings moving left
