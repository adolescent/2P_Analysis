'''
This graph will generate embedding of Color maps in PCA space. The same method as we do on Orietation PCAs.
...
#%% ######################### Step0, Calculate PCA Model (Color) #####################################
...
#%%##################### Step1, Plot 3 embedding maps - Hue (Fig 4C) ##############################
...
#%%####################Step3, Get Recovered Graphs (Fig-4D)###############################
...
#%% ##################Get Recovered Graphs (Fig-4D) -- ver frame##########################
raw_hue_run = ot.Load_Variable(f'{example_loc}\\Color_Frames_Raw.pkl')
raw_spon_run = ot.Load_Variable(f'{example_loc}\\Spon_Before_Raw.pkl')
