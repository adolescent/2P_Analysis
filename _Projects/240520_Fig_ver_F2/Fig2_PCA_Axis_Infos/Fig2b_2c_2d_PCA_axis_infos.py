...
for i in tqdm(range(10)):
    ...
    sns.heatmap(c_pc_graph,center = 0,xticklabels=False,yticklabels=False,ax = axes[i//5,i%5],vmax = value_max,vmin = value_min,cbar_ax= cbar_ax,square=True,cmap = 'gist_gray')
...
sns.heatmap(ac.Generate_Weighted_Cell(spon_pcs[1,:]),center = 0,xticklabels=False,yticklabels=False,ax = axes[0],vmax = value_max,vmin = value_min,cbar_ax= cbar_ax,square=True,cmap = 'gist_gray')
sns.heatmap(ac.Generate_Weighted_Cell(spon_pcs[4,:]),center = 0,xticklabels=False,yticklabels=False,ax = axes[1],vmax = value_max,vmin = value_min,cbar_ax= cbar_ax,square=True,cmap = 'gist_gray')
