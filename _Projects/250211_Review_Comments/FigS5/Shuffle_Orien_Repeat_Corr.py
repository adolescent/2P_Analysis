...
wp = r'G:\我的云端硬盘\#Figs\#250211_Revision1\FigS5'
orien_shuffled = ot.Load_Variable(wp,'Shuffle_FuncMaps.pkl')
ac = ot.Load_Variable(r'D:\_DataTemp\_Fig_Datas\_All_Spon_Data_V1\L76_18M_220902\Cell_Class.pkl')
ac_locs = ac.Cell_Locs
spon_series = ot.Load_Variable(r'D:\_DataTemp\_Fig_Datas\_All_Spon_Data_V1\L76_18M_220902','Spon_Before.pkl')
...
ax.set_zticks([])
fig.tight_layout()
# fig.savefig(ot.join(wp,'exp_SVM_Shuffle_Stim.png'),bbox_inches = 'tight')
# fig.savefig(ot.join(wp,'exp_SVM_Spon_Classified.png'),bbox_inches = 'tight')
fig.savefig(ot.join(wp,'exp_SVM_Spon.png'),bbox_inches = 'tight')
...
for i,c_map in enumerate(stim_rec):
...
# fig.tight_layout()
plt.show()
fig.savefig(ot.join(wp,'Stim_Recover.png'),bbox_inches = 'tight')
#%% Plot bars
plt.clf()
plt.cla()
...
ax.set_xticks([])
fig.savefig(ot.join(wp,'100_Shuffle_Corr.png'),bbox_inches = 'tight')