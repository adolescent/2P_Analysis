...
save_path = r'D:\_Path_For_Figs\240614_Figs_ver_F2\Fig1'
...
fig, axes = plt.subplots(nrows=3, ncols=2, figsize=(14, 8),sharey = 'row',sharex = 'col',dpi = 180)
...
sns.heatmap(spon_freqs[:30,:].T,center = 0,vmax=0.2,ax = ax[0],cbar_ax= cbar_ax,xticklabels=False,yticklabels=False,cbar_kws={'label': 'Prop.'},cmap = 'bwr')
