...
The same script as that in orientation.
'''
...
wp = r'D:\#Fig_Data\_All_Spon_Data_V2\L85_6B_220825'
...
fig.savefig(ot.join(save_path,'Fig5J_Color_V2.png'),bbox_inches='tight')

#%%
'''
Fig 5 FGH , example of PCA embeddings, Color.
'''
...
ax.set_zticks([])
fig.tight_layout()
# fig.savefig(ot.join(save_path,'Fig5H_Stim_Color_PC234.png'),bbox_inches='tight')
# fig.savefig(ot.join(save_path,'Fig5I_Spon_Classified_PC234.png'),bbox_inches='tight')
fig.savefig(ot.join(save_path,'Fig5G_Spon_Raw_PC234.png'),bbox_inches='tight')

#%%
'''
Fig5 IJ recoved color graph for stim and spon.
'''
...
fig.tight_layout()
fig.savefig(ot.join(save_path,'Fig5L_Color_Stim_V2.png'),bbox_inches='tight')
