...
c1.Angle = Orientation1(oriid)-60;
c1.DriftVelocity=TF;
c1.DutyCycle=dutycycle;
c1.Prepare();
c1.GetFrame(1);

c2 = hdMatrixGrating(gratingtype,[sizem*zoomrate,sizem*zoomrate]);
c2.SpatialFrequency = SF;
c2.SpatialPhase = fix(rand(1)*360);
c2.Angle = Orientation1(oriid)+60;
c2.DriftVelocity=TF;
...
for n=1:totalframe
    ...
    crsSetPen1(240);
    crsSetPen2(10);
    curFrame0 = c1.GetFrame(n)+c2.GetFrame(n);
