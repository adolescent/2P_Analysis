...
spon_series = pd.DataFrame(dff_refilter(ac,'1-001',start,end))
orien_series = pd.DataFrame(dff_refilter(ac,ac.orienrun))

# Step2, Get Stim on ids
import re
...
fig.savefig(ot.join(savepath,'Fig1DE_Example_Cell.png'))