...
def All_Cell_Condition_Generator(day_folder,head_extend=3,tail_extend = 3,filter_band = (0.005,0.3),
    ...
    for i,cc in enumerate(acn):
        ...
        for j,c_run in enumerate(used_runs):
            if all_sfa[c_run] != None:
                ...
                Cell_Condition_Dic[cc][c_run] = Condition_Response_Core(c_dF_train, all_sfa[c_run])
...
def Cell_Response_Map(day_folder,Condition_Dics,sub_folder = '_CAIMAN',runname = 'Run007',
    ...
    plot_path = ot.join(work_path,'Response_Curve')
    ot.mkdir(plot_path)
    ...
    for i,cc in enumerate(acn):
        ...
        plotable_data = SDT.CR_Train_Combiner(cc_response, Condition_Dics)
