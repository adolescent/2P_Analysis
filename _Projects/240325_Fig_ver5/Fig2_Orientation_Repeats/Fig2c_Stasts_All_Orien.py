...
sns.boxplot(data = all_repeat_similarity,x = 'Data_Type',y = 'Corr',hue = 'Network',ax = ax,showfliers = False,width = 0.5)
...
sns.boxplot(data = all_repeat_freq,x = 'Network',y = 'Freq',hue = 'Data_Type',ax = ax,showfliers = 0,legend = True,hue_order=['Real_Data','Phase_Shuffle'],width=0.25)
ax.set_title('Stim-like Ensemble Repeat Similarity',size = 10)
ax.set_xlabel('')
...
#%% ###############################FIG 2C_NEW , Plot Freq and Similarity in subplots #############################
all_repeat_similarity = ot.Load_Variable(r'D:\_Path_For_Figs\240228_Figs_v4\Fig2\VerA_Direct_Spon_PCA','Orien_Repeat_Similarity.pkl')
all_repeat_freq = ot.Load_Variable(r'D:\_Path_For_Figs\240228_Figs_v4\Fig2\VerA_Direct_Spon_PCA','Orien_Repeat_Freq.pkl')
#%%
