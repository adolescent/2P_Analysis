...
for i,cloc in tqdm(enumerate(all_path_dic)):
    ...
    analyzer = Classify_Analyzer(ac = ac,model=spon_models,spon_frame=c_spon,od = 0, color = 1,orien = 0)
...
ot.Save_Variable(save_path,'Hue_Repeat_Similarity',all_repeat_similarity)
ot.Save_Variable(save_path,'Hue_Repeat_Freq',all_repeat_freq)