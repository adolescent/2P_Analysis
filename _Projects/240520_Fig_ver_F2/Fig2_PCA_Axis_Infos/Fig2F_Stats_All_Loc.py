'''
This part will do stats on all location, give us:

1. All Loc's 10 PC explained VAR
2. Top 10 PC's best corr

3. Shuffled 500 times' top 10 PC explained VAR(Loc diff)
4.Shuffled 500 times' top 10PC corr
...
plt.cla()
fig,ax = plt.subplots(nrows=1, ncols=1,figsize = (6,4),dpi = 180)
sns.histplot(data = plotable,x = 'Best Corr',ax = ax,hue = 'Data Type', stat="density",common_norm=False,bins = np.linspace(0,0.8,25))
