...
plt.clf()
plt.cla()
fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(4,6),dpi = 180,sharex= False)
...
scatter = sns.scatterplot(data=pivoted_df,x = 'Spontaneous',y = 'Stimulus_ON',s = 3,ax = axes[0],linewidth = 0)
axes[0].set_xlim(0,2)
axes[0].set_ylim(2,0)
