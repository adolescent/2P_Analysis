...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Nstim=16;        % total number of stimulus, used for generate stim parameter vectors (e.g. fixcolor, orientation...)
Ncond=17;        % Ncond = Nstim + number of blanks
...
orientation1=[0:22.5:337.5]';   % 0-180, use 999 for random, orientation 0 is H gratings move up, 90 is Vertical gratings moving left
