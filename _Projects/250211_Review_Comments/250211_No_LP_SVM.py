'''
This will do SVM calssifier on un lp filted data. 
...
spon_series = Z_refilter(ac,start,end,'1-001',0.005,0.3).T # originial spon series
# spon_series = Z_refilter(ac,start,end,'1-001',0.005,False).T
